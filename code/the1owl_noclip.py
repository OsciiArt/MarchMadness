...
sub['Pred'] = sub['ID'].map(results)
sub[['ID', 'Pred']].to_csv('rh3p_submission_noclip.csv', index=False)

"""
Log Loss: 0.302005209883
2015
Log Loss: 0.335813533868
2016
Log Loss: 0.271955897754
2017
Log Loss: 0.323045871311
Testing for Sequence of Scoring
