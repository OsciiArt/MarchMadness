...
df_tourney_list = pd.read_csv('../Minput2/NCAATourneyCompactResults.csv')
...
# load feature
df_tourney_final = pd.read_csv("../additional/Mdf_tourney_final_2018.csv")
...
# Test Set
print("Test Set")
sub = pd.read_csv('../Minput2/SampleSubmissionStage2.csv')
...
sub[['ID', 'Pred']].to_csv('../output/Mstats_2018_AB.csv', index=False)

# 以下ABトリック処理
block = pd.read_csv("../Minput3/NCAATourneySeeds.csv")
...
subA[['ID', 'Pred']].to_csv('../output/Mstats_2018_A.csv', index=False)
...
subB[['ID', 'Pred']].to_csv('../output/Mstats_2018_B.csv', index=False)
