...
# rank_reshaped_ad = pd.DataFrame(rank_reshaped_ad[:,0], columns=['1_',])

print(rank_reshaped_ad.tail())

rank_reshaped = pd.read_csv("../additional/ranking_reshape.csv")
print(rank_reshaped.shape, rank_reshaped_ad.shape)
...
rank_reshaped1 = rank_reshaped.copy()
rank_reshaped1.columns = rank_columns1
rank_reshaped2 = rank_reshaped.copy()
rank_reshaped2.columns = rank_columns2
# rank_reshaped2 = pd.DataFrame(rank_reshaped, columns=rank_columns2)
print(rank_reshaped2.describe())
